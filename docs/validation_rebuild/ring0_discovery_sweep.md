...
- Candidate verdicts: `{'EMERGENT-UNCLASSIFIED': 19, 'MATCH': 3, 'NO-EMERGENCE': 3}`
- EMERGENT-UNCLASSIFIED (correct abstention): **19**
...
| active_nematic | nematic / topological defects | EMERGENT-UNCLASSIFIED×3 | 0.895 | orientation | P6/none | Doostmohammadi et al. 2018, Nat Commun 9:3246 |
