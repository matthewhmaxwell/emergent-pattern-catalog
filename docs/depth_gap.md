...
| P9 | Temporal synchronization (Kuramoto) | PASS | PASS | PASS | PARTIAL | GAP | dim4: K_c=2γ analytical confirmation but no documented Phase-2a sweep against substrate-diverse non-positives | M |
