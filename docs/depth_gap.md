...
- **At-depth: 5 / 19** (P9, P15, P18, P28, P31). P9 added in Sprint 35 via Phase-2a panel v1.2 PASS-with-weakness. Sprint 39 panel runs for P22 (PARTIAL) and P27 (FAIL) do not add new AT-DEPTH patterns; both remain GAP on dim4.
- **Gap: 14 / 19**.
...
- **Sprint 39 finding:** P22 PARTIAL (TNR=0.519) due to Class C failed-regime params above Moore p_c; P27 FAIL (TNR=0.500) due to screening-tier leak on generic lattice_2d substrates + canonical positive finite-size fragility. Both patterns require chat-led sprint for panel redesign before dim4 closure. New carry-forwards: C-p22-class-c-above-percolation, C-p27-panel-screening-leak.
